# 🎵 Vibe Coding with Supermemory

> A step-by-step guide for integrating Supermemory into your application using an AI coding agent.

---

## 📑 Table of Contents

1. [Step 1: Install MCP Server](#step-1-install-mcp-server)
2. [Step 2: Give a Prompt in Your Agent Session](#step-2-give-a-prompt-in-your-agent-session)
3. [Using Supermemory in Claude Code](#using-supermemory-in-claude-code)

---

## Step 1: Install MCP Server

Install and configure a MCP server so that an AI coding agent can read and search Supermemory documentation directly.
...
## Step 2: Give a Prompt in Your Agent Session
...
## Using Supermemory in Claude Code
...
Use Claude Code slash command in your session:
